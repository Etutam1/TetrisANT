...
import PaqueteModelo.ReportException;
...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sonidoButton = new javax.swing.JToggleButton();
        ...
        retryPanelPausaButton.setBackground(new java.awt.Color(0, 0, 0));
        retryPanelPausaButton.setForeground(new java.awt.Color(255, 255, 255));
        ...
        exitPanelPausaButton.setBackground(new java.awt.Color(0, 0, 0));
        exitPanelPausaButton.setForeground(new java.awt.Color(255, 255, 255));
        exitPanelPausaButton.setText("EXIT");
        exitPanelPausaButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        menuPanelPausaButton.setBackground(new java.awt.Color(0, 0, 0));
        menuPanelPausaButton.setForeground(new java.awt.Color(255, 255, 255));
        menuPanelPausaButton.setText("MENU");
        menuPanelPausaButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        panelFondo.add(pauseButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 650, 160, 80));

        sonidoButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/Imagenes/sound.png"))); // NOI18N
        sonidoButton.setBorderPainted(false);
        sonidoButton.setContentAreaFilled(false);
        sonidoButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        sonidoButton.setFocusable(false);
        sonidoButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sonidoButtonActionPerformed(evt);
            }
        });
        panelFondo.add(sonidoButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 760, 60, 60));
        ...
        gameOverOKButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        exitJuegoGameOverButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        retryGameOverButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        exitJuegoTotalScoresButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        menuJuegoTotalScoresButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        exitButtonMenu.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        playButtonMenu.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        playButtonMenu.setFocusable(false);
        playButtonMenu.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/Imagenes/PLAY.gif"))); // NOI18N
        ...
        panelMenu.add(labelTituloTetris, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 350, -1));
        ...
        levelsButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        levelsButton.setFocusable(false);
        levelsButton.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/Imagenes/Levels.gif"))); // NOI18N
        ...
        toggleButtonMenu.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private boolean comprobarPulsacionTeclaD(KeyEvent evt) {
        ...
        return KeyEvent.getKeyText(evt.getKeyCode()).equals("D");
    }

    private boolean comprobarPulsacionTeclaA(KeyEvent evt) {

        return KeyEvent.getKeyText(evt.getKeyCode()).equals("A");
    }

    private boolean comprobarPulsacionTeclaS(KeyEvent evt) {

        return KeyEvent.getKeyText(evt.getKeyCode()).equals("S");
    }

    private boolean comprobarPulsacionTeclaW(KeyEvent evt) {

        return KeyEvent.getKeyText(evt.getKeyCode()).equals("W");
    }
    ...
    private void gameOverOKButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gameOverOKButtonActionPerformed
        try {
            ...
            mostrarJDialogFaltaDispositivoInput();
            this.report.reportarException(ex);
        }
    }//GEN-LAST:event_gameOverOKButtonActionPerformed

    private void mostrarJDialogFaltaDispositivoInput() throws HeadlessException {
        JOptionPane.showMessageDialog(null, "NO SE HA DETECTADO TECLADO O RATÓN");
    }

    private void mostrarJDialogIntroducirNombre() {
    ...
    private boolean comprobarFieldTextEBaleiro() {
        return this.getNombreJugadorLabel().getText().isBlank();
    }
    ...
    private void cambiarImagenBotonesSonido() {
        if (!sonido.getMusica().isRunning()) {
            this.sonidoButton.setIcon(new ImageIcon(("src\\Resources\\Imagenes\\sound.png")));
            this.toggleButtonMenu.setIcon(new ImageIcon(("src\\Resources\\Imagenes\\sound.png")));
        } else {
            this.sonidoButton.setIcon(new ImageIcon(("src\\Resources\\Imagenes\\mute.png")));
    ...
    private void iniciarPartida() {
        ...
        this.gestionarCambioSonidoParaBotones();
        this.mostrarContadores();
        this.xogo.xenerarNovaFicha();
        this.iniciarTimer();
    }

    private void gestionarCambioSonidoParaBotones() {
        if (!sonido.getMusica().isRunning()) {
    ...
    public JToggleButton getToggleButonSonidoJuego() {
        return sonidoButton;
    }
    ...
    public void setToggleButonSonidoJuego(JToggleButton toggleButonSonidoJuego) {
        this.sonidoButton = toggleButonSonidoJuego;
    }
    ...
    private javax.swing.JToggleButton sonidoButton;
